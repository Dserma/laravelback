...
<section class="content-header">
  <h1>
    Administrativo
    <small>Conteúdo da página <b>"Compramos sua cota"</b></small>
  </h1>
  <ol class="breadcrumb">
    <li>
...
<section class="content">
  <div class="row">
    <div class="col-xs-12">
      <form action="#" class="form-conteudo" data-url="{{route('backend.cotas.compramos.salvar')}}">
        <input type="hidden" name="id" value="{{$item->id}}">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Confira abaixo o dados da página <b>"Compramos sua cota"</b></h3>
          </div>
          <div class="box-body">
